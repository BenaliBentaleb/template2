                                ...
                                <table class="table card-table table-vcenter users-table text-nowrap">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-right">
                                                <a class="icon" href="{{route('admin.module.modifie',['id'=>$module->id])}}" title="" data-toggle="tooltip" data-original-title="Modifier">
                                                    <i class="fe fe-edit"></i>
                                                </a>
                                            </td>
                                            <td class="w-0">
                                                <a class="icon" id="delete-module" href="{{route('admin.module.delete',['id'=>$module->id])}}" title="" data-toggle="tooltip" data-original-title="Supprimer">
