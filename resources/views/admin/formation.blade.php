                                ...
                                <table class="table card-table table-vcenter users-table text-nowrap">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-right">
                                                <a class="icon" href="{{route('admin.formation.modifie',['id'=>$formation->id])}}" title="" data-toggle="tooltip" data-original-title="Modifier">
                                                    <i class="fe fe-edit"></i>
                                                </a>
                                            </td>
                                            <td class="w-0">
                                                <a class="icon" id="delete-formation" href="{{route('admin.formation.delete',['id'=>$formation->id])}}" title="" data-toggle="tooltip" data-original-title="Supprimer">
    ...
    <script type="text/javascript">
        var deleter = {
            ...
            handleClick: function (event) {
                ...
                swal({
                        title: "Etes-Vous sur ?",
                        text: "Apres la suppression, TOUS les informations relative à cette formation seront supprimées !",
                        icon: "warning",
                        buttons: true,
                        dangerMode: true,
                    })
