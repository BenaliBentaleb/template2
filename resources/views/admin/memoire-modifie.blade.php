...
<body class="">
                                    ...
                                    <div class="form-group">
                                        <div class="row glutters-xs">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <input name="date" class="form-control" type="text" @if($memoire->date) value="{{$memoire->date}}"  @endif required placeholder="Année" maxlength="4" minlength="4" pattern="[0-2][0-9][0-9][0-9]">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
    ...
    <script type="text/javascript">
        var licence = "";
        @foreach($formations_licence as $formation)
        licence += "<option value='{{$formation->id}}' @if($memoire->type =='licence') selected @endif>{{ $formation->nom }}</option>";
        @endforeach
        var master = "";
        @foreach($formations_master as $formation)
        master = master + "<option value='{{$formation->id}}' @if($memoire->type =='master') selected @endif>{{ $formation->nom }}</option>";
        @endforeach
        console.log(licence);
        console.log(master);
